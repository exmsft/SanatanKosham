...
export const metadata: Metadata = {
  title: "Hindu Deities",
  description: "Explore the Hindu pantheon — the stories, symbolism, and worship of deva and devi.",
};
      ...
      <div style={{ background: "linear-gradient(135deg, var(--deep-blue), var(--royal-purple))", padding: "5rem 2rem 4rem", textAlign: "center" }}>
        <FadeIn>
          ...
          <p style={{ color: "rgba(255,255,255,0.7)", maxWidth: 600, margin: "0 auto", fontSize: "1rem", lineHeight: 1.7 }}>
            The Hindu tradition celebrates the divine in infinite forms — each deity a facet of the one Brahman, expressing a unique quality of the Supreme Reality.
          </p>
        </FadeIn>
      </div>

      <section style={{ padding: "4rem 2rem", maxWidth: 1200, margin: "0 auto" }}>
        <FadeIn><SectionTitle>Deva & Devi</SectionTitle></FadeIn>
        {deities.length === 0 ? (
          <p style={{ textAlign: "center", color: "var(--text-light)" }}>No deities published yet.</p>
        ) : (
